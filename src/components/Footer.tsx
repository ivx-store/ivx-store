    ...
    <footer className="py-8 md:py-12 border-t border-white/10 bg-black/50 backdrop-blur-xl relative z-10 pb-24 md:pb-12">
      <div className="container mx-auto px-5 md:px-8 flex flex-col md:flex-row items-center justify-between gap-4 md:gap-6">
        ...
        <div className="flex items-center gap-4">
          <a href="https://wa.me/9647830796658" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-white hover:text-black text-gray-400 transition-colors shadow-sm border border-white/10">
          ...
          <a href="https://www.instagram.com/ivx_iraq" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-white hover:text-black text-gray-400 transition-colors shadow-sm border border-white/10">
