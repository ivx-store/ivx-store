...
export function Footer() {
  ...
  const whatsappNum = settings?.whatsappNumber || "+9647830796658";
      ...
      <div className="container mx-auto px-5 md:px-8 flex flex-col md:flex-row items-center justify-between gap-4 md:gap-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <a
            ...
            className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-[#25D366] hover:text-white text-gray-400 transition-all duration-300 shadow-sm border border-white/10 hover:border-[#25D366]"
          >
          ...
          {/* Instagram */}
          <a
            href={instaUrl || "https://instagram.com"}
            target="_blank"
            rel="noopener noreferrer"
            className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-gradient-to-tr hover:from-[#f09433] hover:via-[#e6683c] hover:to-[#bc1888] hover:text-white text-gray-400 transition-all duration-300 shadow-sm border border-white/10 hover:border-transparent"
          >
